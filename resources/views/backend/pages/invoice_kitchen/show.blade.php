...
@section('title')
@lang('Details sur facture Cuisine') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Details sur facture Cuisine')</h4>
                    ...
                    @include('backend.layouts.partials.messages')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>Serveur</label>
                                @if($facture->employe)
                                <input type="text" value="{{ $facture->employe->name}}" class="form-control" readonly>
                                @endif
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="tp_fiscal_center" value="DGC" checked="checked" class="form-control" readonly>
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label class="text">DMC
                                    <input type="checkbox" name="tp_fiscal_center" value="DMC" class="form-control" readonly>
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" value="{{ $facture->customer_name}}" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4">
                                <label for="customer_TIN">NIF du client</label>
                                <input type="text" value="{{ $facture->customer_TIN}}" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4">
                                <label for="customer_address">Adresse du client</label>
                                <input type="text" value="{{ $facture->customer_address}}" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
