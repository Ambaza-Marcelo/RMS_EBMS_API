        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    ...
                    <form action="{{ route('admin.invoice-kitchens.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            @endforeach
                                ...
                                <td><input type="number" step='any' min='0' name="item_ct[]" placeholder="TC" class="form-control"/></td>   
                                <td><input type="number" step='any' min='0' name="item_tl[]" placeholder="PFL" class="form-control"/></td>
