...
@section('title')
@lang('Transfert de facture') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Transfert de facture')</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('ebms_api.invoices.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Transfert de facture')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    <h4 class="header-title">Transfert Facture</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('ebms_api.addInvoice',$facture->invoice_number) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="token">JETON</label>
                                <input type="text" placeholder="Un jeton(Clé)" name="token" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" value="{{ $facture->customer_name }}" name="customer_name" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <br>
                         <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><input type="text" name="item_designation[]" value="{{ $data->item_designation }}" class="form-control" readonly /></td>  
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Transmettre</button>
                    </form>
                </div>
            </div>
        </div>
