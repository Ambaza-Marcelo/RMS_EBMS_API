                        ...
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    ...
                                    <th width="10%">@lang('messages.new_price')</th>
                                    <th width="10%">@lang('messages.new_total_value')</th>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ number_format($inventory->unit_price,0,',','.') }}</td>
                                    <td>{{ number_format($inventory->total_value,0,',','.') }} fbu</td>
                                    <td>{{ $inventory->new_quantity }}</td>
                                    <td>{{ $inventory->new_price }} fbu</td>
                                    <td>{{ number_format($inventory->new_total_value,0,',','.') }} fbu</td>
