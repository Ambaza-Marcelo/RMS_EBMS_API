...
@section('title')
@lang('Journal des sorties') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Journal des sorties')</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Journal des sorties</h4>
                <form action="{{ route('admin.journalSortie.export')}}" method="GET">
                    ...
                    <div class="data-tables">
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               @foreach ($journalSorties as $stockout)
                               <tr>
                                    <td>{{ $loop->index+1 }}</td>
