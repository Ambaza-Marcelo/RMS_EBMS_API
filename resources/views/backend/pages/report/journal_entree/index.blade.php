...
@section('title')
@lang('Journal des entrées') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('Journal des entrées')</h4>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Journal des entrées</h4>
                <form action="{{ route('admin.journalEntree.export')}}" method="GET">
                    <p class="float-right mb-2">
                        <button type="submit" class="btn btn-info">Exporter En Excel</button>
                    </p>
                    <p class="float-right mb-2">
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="data-tables">
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               @foreach ($journalEntrees as $stockin)
                               <tr>
                                    <td>{{ $loop->index+1 }}</td>
                                    <td>{{ $stockin->date }}</td>
