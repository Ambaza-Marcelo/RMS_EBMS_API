                      ...
                      "<td>"+
                        ...
                        "<td>"+
                          "<select class='form-control' name='unit[]' id='unit'>"+
                                "<option disabled='disabled' selected='selected'>Merci de choisir</option>"+
                                "<option value='meters' class='form-control'>Meters</option>"+
                                "<option value='pieces' class='form-control'>Pieces</option>"+
                                "<option value='kilogram' class='form-control'>Kilogram</option>"+
                                "<option value='liter' class='form-control'>Liter</option>"+
                                "<option value='box' class='form-control'>Box</option>"+
                                "<option value='box' class='form-control'>Pack</option>"+
                                "</select>"+
                        "</td>"+
                        "<td>"+
